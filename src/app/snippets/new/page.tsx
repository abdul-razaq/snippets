...
export default function SnippetCreatePage() {
  ...
  return (
    <form action={action} className='border-2 w-1/2 p-10 mx-auto rounded-lg mt-20 flex flex-col items-center justify-center'>
      ...
      {
        formState.message && <p className='bg-red-300 font-sans font-medium text-sm lowercase p-2 text-white text-center my-2 border border-red-600 rounded'>{formState.message}</p>
      }
